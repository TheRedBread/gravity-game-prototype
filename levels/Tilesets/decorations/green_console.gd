...
const green_light = preload("res://levels/Tilesets/decorations/green_console_light.tres")
const blue_light = preload("res://levels/Tilesets/decorations/blue_console_light.tres")
